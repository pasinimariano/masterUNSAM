...
# ¿En qué linea está el error? El error se encuentra en la linea 11.

# ¿Cuál es el error? Se invoca una variable que no existe, es necesario prestar atencion al nombre de las variables.

# Repará el error. 11 >>> dia = dias + 1. 
# Solucion. 11 >>> dia = dia + 1
